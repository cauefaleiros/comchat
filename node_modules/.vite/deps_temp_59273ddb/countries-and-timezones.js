...
// node_modules/.pnpm/countries-and-timezones@3.6.0/node_modules/countries-and-timezones/esm/index.js
...
var timezonesMap;
function buildCountry(data2, id) {
  var name = data2.countries[id];
  if (!name) return null;
  var tzMap = getTimezonesMap(data2)[id] || {};
  return {
    id,
    name,
...
function getTimezonesMap(data2) {
  if (!timezonesMap) timezonesMap = buildTimezonesMap(data2);
  return timezonesMap;
}
function buildTimezonesMap(data2) {
  return Object.keys(data2.timezones).reduce(function(result, id) {
    var tz = data2.timezones[id];
    var c = tz.c, a = tz.a;
    var aliasTz = data2.timezones[a] || {};
    var countries2 = c || aliasTz.c;
...
function buildTimezone(data2, name) {
  var timezone = data2.timezones[name];
  if (!timezone) return null;
  var _timezone$a = timezone.a, aliasOf = _timezone$a === void 0 ? null : _timezone$a;
  var aliasTz = aliasOf ? data2.timezones[aliasOf] : {};
  var tz = _objectSpread2(_objectSpread2({}, aliasTz), data2.timezones[name]);
  var countries2 = tz.c || [];
  var utcOffset = tz.u;
...
//# sourceMappingURL=countries-and-timezones.js.map
