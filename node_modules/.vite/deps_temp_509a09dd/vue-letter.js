...
// node_modules/.pnpm/vue-letter@0.2.1/node_modules/vue-letter/dist/vue-letter.js
init_vue_esm_bundler();
var S = {
...
function J(t, { dropAllHtmlTags: o = false, rewriteExternalLinks: i, rewriteExternalResources: s, id: l = "msg_" + String.fromCharCode(...new Array(24).fill(void 0).map(() => Math.random() * 25 % 25 + 65)), allowedSchemas: n = O, allowedCssProperties: a = W, preserveCssPriority: p = true, noWrapper: h = false }) {
  var A, _, z, R, M;
  h && (l = "");
...
var $ = defineComponent({
  ...
  setup(t) {
    ...
    return (L, N) => unref(n) ? unref(n) ? (openBlock(), createElementBlock("div", {
      key: 1,
    ...
    ], 2)) : createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
      key: 0,
      class: normalizeClass([unref(i)]),
      innerHTML: unref(C)
    }, null, 10, X));
...
//# sourceMappingURL=vue-letter.js.map
